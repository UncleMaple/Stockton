...
import 'package:stockton/presentation/calendar/calendar_item.dart';
import 'package:stockton/presentation/calendar/calendar_screen_view_model.dart';
...
class CalendarScreen extends StatelessWidget {
  ...
  _buildHeaderItem(
    ...
    final datePrefix = item.isToday
        ? StocktonLocalizations.of(context).calendarStringToday
        : "";
    return Opacity(
        ...
        child: Center(
            child: Container(
              ...
              child: Center(
                  child: Text(
                    isAllDay
                        ? StocktonLocalizations.of(context).calendarStringAllDay
  ...
  _selectCalendarEvent({
    ...
    provider.dispatch(
      SelectChannelIdAction(
        ...
        memberId: provider.state.member.id,
                    ...
                    Positioned.fill(
                      child: Align(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            StocktonLocalizations.of(context).calendarTitle,
