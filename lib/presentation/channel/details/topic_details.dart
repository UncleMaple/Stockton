...
import 'package:stockton/presentation/channel/details/topic_details_view_model.dart';
...
class _TopicDetailsWidgetState extends State<_TopicDetailsWidget>
  ...
  TabBar _buildTabBar() {
    return TabBar(
      ...
      tabs: <Widget>[
        _buildTab(StocktonLocalizations.of(context).topicDetails),
        _buildTab(StocktonLocalizations.of(context).topicMembers),
      ],
      ...
      case ChannelVisibility.CLOSED:
        return Row(
          children: <Widget>[
            ...
            Text(
              StocktonLocalizations.of(context).topicPrivate,
  ...
  Padding _buildLeaveChannelButton() {
    return Padding(
      ...
      child: Center(
        child: FlatButton(
          child: Text(
            StocktonLocalizations.of(context).topicLeave,
    ...
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        if (index < widget.vm.members.length) {
          ...
          return MemberItem(
            member: member,
            isYou: widget.vm.memberId == member.id,
          );
        } else {
          return Padding(
            padding: const EdgeInsets.all(AppTheme.appMargin),
            child: RoundButton(
              text: StocktonLocalizations.of(context).channelInviteButton,
              onTap: () {
