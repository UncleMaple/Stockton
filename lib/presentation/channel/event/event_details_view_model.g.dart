...
class _$EventDetailsViewModel extends EventDetailsViewModel {
  ...
  @override
  final BuiltMap<int, RSVP> rsvpStatus;
  @override
  ...
  _$EventDetailsViewModel._(
    ...
    if (member == null) {
      throw new BuiltValueNullFieldError('EventDetailsViewModel', 'member');
    }
    if (memberRsvp == null) {
      throw new BuiltValueNullFieldError('EventDetailsViewModel', 'memberRsvp');
    }
    if (editable == null) {
...
class EventDetailsViewModelBuilder
  ...
  MapBuilder<int, RSVP> _rsvpStatus;
  MapBuilder<int, RSVP> get rsvpStatus =>
      _$this._rsvpStatus ??= new MapBuilder<int, RSVP>();
  set rsvpStatus(MapBuilder<int, RSVP> rsvpStatus) =>
  ...
  RSVP _memberRsvp;
  RSVP get memberRsvp => _$this._memberRsvp;
  set memberRsvp(RSVP memberRsvp) => _$this._memberRsvp = memberRsvp;
