    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          _buildButton(
            context,
            text: StocktonLocalizations.of(context).eventRsvpYes,
          ...
          _buildButton(
            context,
            text: StocktonLocalizations.of(context).eventRsvpMaybe,
            rsvp: RSVP.MAYBE,
          ),
          _buildButton(
            context,
            text: StocktonLocalizations.of(context).eventRsvpNo,
            rsvp: RSVP.NO,
          ),
        ],
      ),
